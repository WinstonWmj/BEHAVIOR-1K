...
RUN_EPISODE_IDXS=${RUN_EPISODE_IDXS:-'[100010,100020,100030,100040,100050,100060,100070,100080,100090,100100,100110,100120,100130,100140,100150,100160,100170,100180,100190,100200]'}  # Example: [10,100010]
SUBTASK_INDEX=${SUBTASK_INDEX:-0}
SUBTASK_END_INDEX=${SUBTASK_END_INDEX:-15}  # 3 3 7 11 15
SUBTASK_SKILL=${SUBTASK_SKILL:-'place on next to'}  # Example: press_radio / pickup_from_support / "press"
MAX_STEPS=${MAX_STEPS:-}
...
LOG_BASE=./logs/${EVAL_LEVEL}_eval/${TASK}-placeonnextto-task_reward/warmup-${TASK}-placeonnextto-warmupcontinue
