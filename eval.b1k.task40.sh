...
TASK=make_microwave_popcorn # turning_on_radio hanging_pictures make_microwave_popcorn picking_up_trash set_up_a_coffee_station_in_your_kitchen
...
RUN_EPISODE_IDXS=${RUN_EPISODE_IDXS:-'[400010,400020]'}  # Example: [10,100010]
# RUN_EPISODE_IDXS=${RUN_EPISODE_IDXS:-'[400010,400020,400030,400040,400050,400060,400070,400080,400090,400100,400110,400120,400130,400140,400150,400160,400170,400180,400190,400200]'}  # Example: [10,100010]
