...
RUN_EPISODE_IDXS=${RUN_EPISODE_IDXS:-'[100020,100040,100060,100070]'}  # Example: [10,100010]
...
LOG_BASE=./logs/${EVAL_LEVEL}_eval/${TASK}-placein-task_reward/warmup-${TASK}-placein-warmupcontinue
